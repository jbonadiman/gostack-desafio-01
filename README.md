...
## TODO (adicionais) <h2>
  ...
  4. Adicionar interface por CLI (Node.js, Python ou bash);
  5. Adicionar interface Web (React);
  6. Adicionar interface Desktop (Electron);
  7. Adicionar interface Mobile (React-Native);
